				...
				<div class="card-body">
					<form action="{{ route('updateHubungi_Kami',['id'=>$hubungikami->id]) }}" method="post">
						...
						<div class="form-group">
							...
							<input type="text" name="nomorponsel" id="nomor_ponsel" class="form-control" required="required" value="{{ $hubungikami->nomor_ponsel }}" placeholder="Masukkan nomor ponsel">
						</div>
