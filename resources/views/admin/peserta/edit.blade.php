...
<div class="content-wrapper">
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right d-flex">
						...
						<li class="breadcrumb-item active" style="align-items: center; display: flex;">Edit Peserta</li>
					</ol>
				</div>
			</div>
		</div>
	...
	<div class="content">
		<div class="container-fluid">
			<div class="card">
				<div class="card-body">
					<form action="{{ route('updatePeserta',['id'=>$peserta->id]) }}" method="post">
						{{ csrf_field() }}
...
>>>>>>> 8a8b1e0d3fb23705eeedc5f741612dcae2a73a3c
						...
						<div class="form-group">
							...
							<input type="text" name="jumlah_dana" id="jumlah_dana" class="form-control" required="required" value="{{ $peserta->jumlah_dana }}" placeholder="Masukkan jumlah_dana">
						</div>

						<div class="form-group">
							<label for="nama_peserta">nama_peserta</label>
							<input type="text" name="nama_peserta" id="nama_peserta" class="form-control" required="required" value="{{ $peserta->nama_peserta }}" placeholder="Masukkan nama_peserta">
						</div>

						<div class="form-group">
							<label for="nama_panggilan">nama_panggilan</label>
							<input type="text" name="nama_panggilan" id="nama_panggilan" class="form-control" required="required" value="{{ $peserta->nama_panggilan }}" placeholder="Masukkan nama_panggilan">
						</div>
...
>>>>>>> 8a8b1e0d3fb23705eeedc5f741612dcae2a73a3c
                        ...
                        <div class="form-group">
							...
							<input type="text" name="hubungan" id="hubungan" class="form-control" required="required" value="{{ $peserta->hubungan }}" placeholder="Masukkan hubungan">
						</div>

						<div class="text-right">
							<a href="{{ route('daftarPeserta') }}" class="btn btn-outline-secondary mr-2" role="button">Batal</a>
