				...
				<div class="card-body">
					<form action="{{ route('storePelanggan') }}" method="post">
						...
						<div class="form-group">
							...
							<input type="text" name="foto" id="foto" class="form-control" required="required" placeholder="Masukkan foto">
						</div>

						<div class="form-group">
							<label for="waktu_daftar">waktu_daftar</label>
							<input type="text" name="waktu_daftar" id="waktu_daftar" class="form-control" required="required" placeholder="Masukkan waktu_daftar">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="email_pelanggan" id="email_pelanggan" class="form-control" required="required" placeholder="Masukkan email_pelanggan">
						</div>

						<div class="form-group">
							<label for="password">password</label>
							<input type="text" name="password" id="password" class="form-control" required="required" placeholder="Masukkan password">
						</div>
                        ...
                        <div class="form-group">
							...
							<input type="text" name="level_user" id="level_user" class="form-control" required="required" placeholder="Masukkan level_user">
						</div>
