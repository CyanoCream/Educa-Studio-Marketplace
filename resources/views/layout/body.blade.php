        ...
        <div class="row">
                ...
                <div class="kodory-banner style-01 left-top new">
                    <div class="banner-inner">
                        <figure class="banner-thumb">
                            <img src="{{asset('images/priv.jpeg')}}" class="attachment-full size-full" alt="img">
                        </figure>
                        <div class="banner-info ">
                            <div class="banner-content">
                                <div class="title-wrap">
                                    <h6 class="title">
                                        <a target="_self" href="#1547652538969-4e9e849f-123a-5d80aefaa70e2">New
                                            Program</a>
                                    </h6>
                                </div>
                            </div>
            ...
            <div class="col-md-7">
                <div class="kodory-banner style-01 left-center">
                    <div class="banner-inner">
                        <figure class="banner-thumb">
                            <img src="{{asset('images/kursus.jpg')}}" class="attachment-full size-full" alt="img">
                        </figure>
                        <div class="banner-info ">
                            <div class="banner-content">
                                <div class="title-wrap">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="kodory-banner style-01 left-top  kodory_custom_5d67efefec0b8 ">
                            <div class="banner-inner">
                                <figure class="banner-thumb">
                                    <img src="{{asset('images/aktiv1.jpg')}}" class="attachment-full size-full"
                                        alt="img"></figure>
                                <div class="banner-info ">
                                    <div class="banner-content">
                                        <div class="title-wrap">
                    ...
                    <div class="col-6">
                        <div class="kodory-banner style-01 left-bottom">
                            <div class="banner-inner">
                                <figure class="banner-thumb">
                                    <img src="{{asset('images/aktiv2.jpg')}}" class="attachment-full size-full"
                                        alt="img"></figure>
                                <div class="banner-info ">
                                    <div class="banner-content">
                                        <div class="title-wrap">
        ...
        <div class="kodory-tabs style-01">
            <div class="tab-head">
                <ul class="tabs dreaming-tabs" role="tablist">
                    ...
                    <li class="description_tab active" id="tab-title-description" role="tab"
                        ...
                        <a href="#tab-description">Most Popular</a>
                    </li>
                    <li class="reviews_tab" id="tab-title-reviews" role="tab" aria-controls="tab-reviews">
                        <a href="#tab-reviews">Limited</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="kodory-Tabs-panel kodory-Tabs-panel--description panel entry-content kodory-tab justify-content-conter"
                ...
                <div class="tab-container row">
                    ...
                    <div v-for="po in popular" :key="po.id" class="tab-panel active col-6 col-md-4 col-lg-3"
                                    ...
                                    <div class="product-inner tooltip-left"
                                        ...
                                        <div class="product-thumb">
                                            ...
                                            <div class="group-button">
                                                <a href="#" v-on:click="getData(po.id)"
                                        ...
                                        <div class="product-info equal-elem">
                                            ...
                                            <p class="m-1"><i class="fa fa-clock-o pr-1" aria-hidden="true"></i>
                                                @{{ po.waktu_temu }}.Menit</p>
                                            <p class="m-1"><i class="fa fa-map-marker pr-2" aria-hidden="true"></i>
                                                @{{ po.status_pertemuan }}</p>
                                            <span class="price">
                                                <span class="kodory-Price-amount amount">
                                                    <span
                                                        class="kodory-Price-currencySymbol">Rp.</span>@{{ po.harga_produk }}
                                                </span>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-inner tooltip-left"
                                        ...
                                        <div class="product-thumb">
                                            ...
                                            <div class="flash">
                                                <span class="onnew"><span class="text">New</span></span></div>
                                            <div class="group-button">
                                                <a href="#" v-on:click="getData(pr.id)"
                                                    class="button yith-wcqv-button">Quick View</a>
                                                <div class="add-to-cart">
                                                    <a href="#"
                                                        class="button product_type_simple add_to_cart_button ajax_add_to_cart">Add
                                        ...
                                        <div class="product-info equal-elem">
                                            ...
                                            <span class="price">
                                                <span class="kodory-Price-amount amount">
                                                    <span
                                                        class="kodory-Price-currencySymbol">Rp.</span>@{{ pr.harga_produk }}
                                                </span>
                                            </span>
                                        </div>
                                    </div>
            ...
            <div class="kodory-Tabs-panel kodory-Tabs-panel--reviews panel entry-content kodory-tab" id="tab-reviews"
                role="tabpanel" aria-labelledby="tab-title-reviews">
                <div id="reviews" class="kodory-Reviews">
                    <div id="comments">
                        <h2 class="kodory-Reviews-title">Limited</h2>

                    </div>
                    <div class="tab-container row">

                        <div v-for="l in limited" :key="l.id" class="tab-panel active col-6 col-md-4 col-lg-3"
                            id="1547652538969-4e9e849f-123a-5d80aefaa70e2">
                            <div class="kodory-products style-01">
                                <div
                                    class="response-product product-list-grid row auto-clear equal-container better-height ">
                                    <div
                                        ...
                                        <div class="product-inner tooltip-left"
                                            ...
                                            <div class="product-info equal-elem">
                                                <h3 class="product-name product_title">
                                                    <a href="#" v-on:click="getData(l.id)">@{{ l.nama_produk }}</a>
                                                </h3>
                                                <p class="m-1"><i class="fa fa-calendar-o pr-2"
                                                        aria-hidden="true"></i>@{{ l.pertemuan }}</p>
                                                <p class="m-1"><i class="fa fa-clock-o pr-1" aria-hidden="true"></i>
                                                    @{{ l.waktu_temu }}.Menit</p>
                                                <p class="m-1"><i class="fa fa-map-marker pr-2" aria-hidden="true"></i>
                                                    @{{ l.status_pertemuan }}</p>
                                                <span class="price">
                                                    <span class="kodory-Price-amount amount">
                                                        <span
                                                            class="kodory-Price-currencySymbol">Rp.</span>@{{ l.harga_produk }}
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
...
<div class="section-023">
    <div class="kodory-banner style-11 left-center">
        <div class="banner-inner">
            <figure class="banner-thumb">
                <img src="{{asset('images/home 1.jpg')}}" class="attachment-full size-full" alt="img"></figure>
        ...
        <div class="kodory-slide">
            <div class="owl-slick equal-container better-height"
                ...
                <div class="dreaming_single_image dreaming_content_element az_align_center">
                    <figure class="dreaming_wrapper az_figure">
                        <div class="az_single_image-wrapper   az_box_border_grey effect bounce-in ">
                            <img src="{{asset('images/loggo2.1.jpeg')}}" class="az_single_image-img attachment-full"
                ...
                <div class="dreaming_single_image dreaming_content_element az_align_center">
                    <figure class="dreaming_wrapper az_figure">
                        <div class="az_single_image-wrapper   az_box_border_grey effect bounce-in ">
                            <img src="{{asset('images/loggo2.3.jpeg')}}" class="az_single_image-img attachment-full"
                                alt="img" width="200" height="100">
                        </div>
                    </figure>
                </div>
                <div class="dreaming_single_image dreaming_content_element az_align_center">
                    <figure class="dreaming_wrapper az_figure">
                        <div class="az_single_image-wrapper   az_box_border_grey effect bounce-in ">
                            <img src="{{asset('images/loggo2.2.jpeg')}}" class="az_single_image-img attachment-full"
                                alt="img" width="200" height="100">
                        </div>
                    </figure>
                </div>
                <div class="dreaming_single_image dreaming_content_element az_align_center">
                    <figure class="dreaming_wrapper az_figure">
                        <div class="az_single_image-wrapper   az_box_border_grey effect bounce-in ">
                            <img src="{{asset('images/loggo2.5.jpeg')}}" class="az_single_image-img attachment-full"
                                alt="img" width="200" height="100">
                        </div>
                    </figure>
                </div>
                <div class="dreaming_single_image dreaming_content_element az_align_center">
                    <figure class="dreaming_wrapper az_figure">
                        <div class="az_single_image-wrapper   az_box_border_grey effect bounce-in ">
                            <img src="{{asset('images/loggo2.4.jpeg')}}" class="az_single_image-img attachment-full"
                                alt="img" width="200" height="100">
                        </div>
                    </figure>
                </div>
